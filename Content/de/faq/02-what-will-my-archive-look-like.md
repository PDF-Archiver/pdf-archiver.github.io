---
title: Wie sieht mein Archiv aus?
---
...
Datum, Beschreibung und Tags sind Teil des Dateinamens. Großbuchstaben, Leerzeichen und sprachspezifische Zeichen wie `ä, ö, ü, ß` werden entfernt, damit die Namen in jedem Dateisystem funktionieren.
