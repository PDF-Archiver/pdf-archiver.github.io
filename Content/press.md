...
[App Store](https://apps.apple.com/app/pdf-archiver/id1433801905) · [Source code](https://github.com/PDF-Archiver/PDF-Archiver)
...
**Who it is for:** Anyone with paperwork worth keeping — tax records, contracts, medical letters — who wants order without handing those documents to a cloud service.

## Reviewing the app

Write to [press@pdf-archiver.io](mailto:press@pdf-archiver.io) and you will get a promo code for full access, no strings attached. Happy to answer questions about how the app works, and to provide additional screenshots.
